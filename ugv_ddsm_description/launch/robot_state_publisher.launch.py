...
ARGUMENTS = [
    DeclareLaunchArgument('robot_name', default_value='ugv_ddsm',
...
def generate_launch_description():
    ...
    """
    # Define filenames
    urdf_package = 'ugv_ddsm_description'
    urdf_filename = 'Robot_wrapper.urdf.xacro'
    rviz_config_filename = 'ugv_ddsm_description.rviz'
