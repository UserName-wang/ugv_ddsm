...
def generate_launch_description():
    ...
    package_name_gazebo = 'ugv_ddsm_gazebo'
    package_name_description = 'ugv_ddsm_description'
    package_name_bringup = 'ugv_ddsm_bringup'

    default_robot_name = 'ugv_ddsm'
    gazebo_models_path = 'models'
    default_world_file = 'empty.world'
    gazebo_worlds_path = 'worlds'
    ros_gz_bridge_config_file_path = 'config/ros_gz_bridge.yaml'
    rviz_config_filename = 'ugv_ddsm_gazebo_sim.rviz'
